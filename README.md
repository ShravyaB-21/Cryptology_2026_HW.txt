...
| Amazon         | Firewalls + Load Balancers                     | Availability                   | Blocks malicious traffic (like DDoS attacks) from crashing the site                                 |Amazon constantly monitors traffic patterns.  | Redirects traffic to backup servers to keep site running                                           | Firewall, DDoS protection, Load Balancing                                                                                                    | 
...
|Alexa           | Device Authentication + Firmware Updates       |	Confidentiality + Availability| Stops unauthorized devices from connecting to the home network/hub	                           | Detects unusual command patterns                                                                                                                                            | 	Auto-updates firmware to patch vulnerabilities and the device daacan factory reset if compromised	| Device Pairing Protocols, OTA Updates, WPA3 Wi-Fi Security                                                                                             |
